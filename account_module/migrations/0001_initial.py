    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number', models.IntegerField(blank=True, null=True, unique=True, verbose_name='شماره موبایل')),
                ('number_is_active', models.BooleanField(default=False, verbose_name='فعال بودن/نبودن شماره')),
                ('number_active_code', models.IntegerField(verbose_name='کد فعالسازی شماره')),
                ('email_active_code', models.CharField(max_length=100, verbose_name='کد فعالسازی ایمیل')),
                ('abuot_user', models.TextField(blank=True, null=True, verbose_name='درباره شخص')),
